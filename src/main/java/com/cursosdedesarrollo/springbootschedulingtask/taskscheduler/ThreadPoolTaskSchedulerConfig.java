package com.cursosdedesarrollo.springbootschedulingtask.taskscheduler;
...
@Configuration
@ComponentScan(basePackages = "com.cursosdedesarrollo.springbootschedulingtask.taskscheduler", basePackageClasses = { ThreadPoolTaskSchedulerExamples.class })
